// deploy: npx hardhat deploy --network goerli --tags AwesomeERC20v1
...
module.exports = async function({deployments, getChainId, getNamedAccounts, getUnnamedAccounts}) {
	...
	{
		// deploy if required
		await deployments.deploy("AwesomeERC20v1", {
		...
		const deployment = await deployments.get("AwesomeERC20v1");
...
module.exports.tags = ["AwesomeERC20v1", "deploy"];
