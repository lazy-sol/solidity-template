// deploy: npx hardhat deploy --network goerli --tags TetherToken
...
module.exports = async function({deployments, getChainId, getNamedAccounts, getUnnamedAccounts}) {
	...
	{
		// deploy if required
		await deployments.deploy("TetherToken", {
		...
		const deployment = await deployments.get("TetherToken");
...
module.exports.tags = ["TetherToken", "deploy"];
