// deploy: npx hardhat deploy --network goerli --tags AwesomeERC721_Proxy
...
module.exports = async function({deployments, getChainId, getNamedAccounts, getUnnamedAccounts}) {
	...
	// AwesomeERC721v1 ERC1967Proxy
	{
		...
		const proxy_init_data = v1_contract.methods.postConstruct(NAME, SYMBOL).encodeABI();

		// deploy ERC1967 Proxy
		await deployments.deploy("AwesomeERC721_Proxy", {
...
module.exports.tags = ["AwesomeERC721_Proxy", "deploy"];
module.exports.dependencies = ["AwesomeERC721v1"];
