// deploy: npx hardhat deploy --network goerli --tags AwesomeERC721v1
...
module.exports = async function({deployments, getChainId, getNamedAccounts, getUnnamedAccounts}) {
	...
	{
		// deploy if required
		await deployments.deploy("AwesomeERC721v1", {
		...
		const deployment = await deployments.get("AwesomeERC721v1");
...
module.exports.tags = ["AwesomeERC721v1", "deploy"];
