// deploy: npx hardhat deploy --network goerli --tags upgrade-AwesomeERC721v1
...
module.exports = async function({deployments, getChainId, getNamedAccounts, getUnnamedAccounts}) {
	...
	// AwesomeERC721v1 ERC1967Proxy
	{
		// get deployment details
		const v1_deployment = await deployments.get("AwesomeERC721v1");
		...
		const proxy_deployment = await deployments.get("AwesomeERC721_Proxy");
		...
		if(implementation_address !== web3.utils.toChecksumAddress(v1_deployment.address)) {
			...
			console.log("AwesomeERC721_Proxy.upgradeTo(%o): %o", v1_deployment.address, receipt.transactionHash);
		}
	}
};
...
module.exports.tags = ["upgrade-AwesomeERC721v1", "upgrade"];
module.exports.dependencies = ["AwesomeERC721v1", "AwesomeERC721v1_Proxy"];
