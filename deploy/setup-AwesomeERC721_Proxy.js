// run: npx hardhat deploy --network goerli --tags setup-AwesomeERC721_Proxy
...
module.exports = async function({deployments, getChainId, getNamedAccounts, getUnnamedAccounts}) {
	...
	// setup AwesomeERC721
	{
		...
		if(!features.eq(requested_features)) {
			...
			console.log("AwesomeERC721_Proxy.updateFeatures(%o): %o", requested_features.toString(2), receipt.transactionHash);
		}
	}
};
...
module.exports.tags = ["setup-AwesomeERC721_Proxy"];
module.exports.dependencies = ["AwesomeERC721_Poxy"];
